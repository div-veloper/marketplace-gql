            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="flex justify-between h-16">
                    ...
                    <div className="ml-6 flex items-center">
                        ...
                        {
                            !user ? (
                                <a href='/api/auth/login' className='rounded-md border bg-purple-100 px-2 py-3 mr-2 ml-2'>Login as Vendor</a>
                            ) : (
                                <>
                                    <img src={ user.picture } className='rounded-full w-8 h-8 ml-8' />
